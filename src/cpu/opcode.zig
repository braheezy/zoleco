...
pub const OpcodeTable = [256]?OpcodeHandler{
    nop, immi.load_BC, dti.stax_B, rpi.inx_B, rsi.inr_B, rsi.dcr_B, immi.moveImm_B, rai.rlc, li.ex_AF, rpi.dad_B, dti.loadAddr_B, null, rsi.inr_C, rsi.dcr_C, immi.moveImm_C, null, // 00 - 0F
    null, immi.load_DE, dti.stax_D, rpi.inx_D, rsi.inr_D, rsi.dcr_D, immi.moveImm_D, null, null, rpi.dad_D, dti.loadAddr_D, null, rsi.inr_E, rsi.dcr_E, immi.moveImm_E, null, // 10 - 1F
    null, immi.load_HL, null, rpi.inx_H, rsi.inr_H, rsi.dcr_H, immi.moveImm_H, null, null, rpi.dad_H, null, null, rsi.inr_L, rsi.dcr_L, immi.moveImm_L, null, // 20 - 2F
    null, immi.load_SP, null, rpi.inx_SP, rsi.inr_M, rsi.dcr_M, immi.moveImm_M, null, null, rpi.dad_SP, null, null, rsi.inr_A, rsi.dcr_A, immi.moveImm_A, null, // 30 - 3F
