...
pub const Config = struct {
    ...
    pub fn init() !Config {
        const input_1 = Input{
            ...
            .zero = SDL.SDL_SCANCODE_KP_0,
            .one = SDL.SDL_SCANCODE_KP_1,
            .two = SDL.SDL_SCANCODE_KP_2,
            .three = SDL.SDL_SCANCODE_KP_3,
            .four = SDL.SDL_SCANCODE_KP_4,
            .five = SDL.SDL_SCANCODE_KP_5,
            .six = SDL.SDL_SCANCODE_KP_6,
            .seven = SDL.SDL_SCANCODE_KP_7,
            .eight = SDL.SDL_SCANCODE_KP_8,
            .nine = SDL.SDL_SCANCODE_KP_9,
            .asterisk = SDL.SDL_SCANCODE_KP_MULTIPLY,
            .hash = SDL.SDL_SCANCODE_KP_DIVIDE,
            .gamepad = true,
